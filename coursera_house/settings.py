...
STATIC_URL = '/static/'
SMART_HOME_ACCESS_TOKEN = "30a7c7fe1d274611f84660413a04365651210fc456038388cfb5efe3105a6942"
SMART_HOME_API_URL = "http://smarthome.t3st.ru/api/"
EMAIL_USE_TLS = True # здесь укажите настройки вашей почты
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_HOST_USER = '' # почта с которой будут отправляться письма
EMAIL_HOST_PASSWORD = '' # пароль от почты
EMAIL_PORT = 587
EMAIL_RECEPIENT = '?' # Сюда введите email владельца дома
